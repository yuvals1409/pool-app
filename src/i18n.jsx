...
const T = {
  he: {
    ...
    contactPickerEnableIOS: "ב-iPhone: הגדרות → Safari → מתקדם → תכונות ניסיוניות → הפעילו Contact Picker API, ואז רעננו את הדף",
  ...
  en: {
    ...
    contactPickerEnableIOS: "On iPhone: Settings → Safari → Advanced → Feature Flags → enable Contact Picker API, then refresh",
  ...
  ru: {
    ...
    contactPickerEnableIOS: "На iPhone: Настройки → Safari → Дополнительно → Экспериментальные функции → включите Contact Picker API и обновите страницу",
