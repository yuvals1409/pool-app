...
const T = {
  he: {
    ...
    lessonOnce: "שיעור חד-פעמי",
    lessonRecurring: "שיעור קבוע",
  ...
  en: {
    ...
    lessonOnce: "One-time lesson",
    lessonRecurring: "Recurring lesson",
  ...
  ru: {
    ...
    lessonOnce: "Разовый урок",
    lessonRecurring: "Постоянный урок",
