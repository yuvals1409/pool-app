...
const T = {
  he: {
    ...
    parentPhoneManualHint: "ב-iPhone אין גישה לאנשי קשר מהדפדפן — הזינו את מספר ההורה ידנית",
    contactPickerUnsupported: "לא ניתן לפתוח אנשי קשר בדפדפן זה — השתמשו ב-Chrome בטלפון אנדרואיד",
  ...
  en: {
    ...
    parentPhoneManualHint: "iPhone browsers cannot access contacts — enter the parent's number manually",
    contactPickerUnsupported: "Cannot open contacts in this browser — use Chrome on an Android phone",
  ...
  ru: {
    ...
    parentPhoneManualHint: "В браузере iPhone нет доступа к контактам — введите номер вручную",
    contactPickerUnsupported: "Не удалось открыть контакты — используйте Chrome на Android",
