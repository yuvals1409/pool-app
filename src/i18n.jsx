...
const T = {
  he: {
    ...
    contactPickerUnsupported: "הדפדפן לא תומך בבחירת אנשי קשר — פתחו את האפליקציה ב-Chrome בטלפון",
  ...
  en: {
    ...
    contactPickerUnsupported: "This browser does not support contact picking — open the app in Chrome on your phone",
  ...
  ru: {
    ...
    contactPickerUnsupported: "Браузер не поддерживает выбор контактов — откройте приложение в Chrome на телефоне",
