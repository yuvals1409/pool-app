...
async function build() {
  ...
  s1.addImage({ path: SL_LOGO, x: 7.5, y: 0.3, w: 2.2, h: 1.1 });
  s1.addImage({ path: NO_LOGO, x: 8.0, y: 4.2, w: 1.5, h: 1.2 });
  s1.addText("STREAM LINE", { x: 0.5, y: 1.0, w: 7, h: 1.2, fontSize: 48, fontFace: "Arial", bold: true, color: C.white, align: "right", margin: 0 });
  ...
  for (let i = 0; i < features.length; i++) {
    s4.addImage({ data: icons.check, x: 8.8, y: 1.2 + i * 0.55, w: 0.3, h: 0.3 });
    s4.addText(features[i], { x: 0.5, y: 1.2 + i * 0.55, w: 8.1, h: 0.4, fontSize: 14, fontFace: "Arial", color: C.text, align: "right", margin: 0 });
  }
  s4.addShape(pres.shapes.ROUNDED_RECTANGLE, { x: 0.5, y: 4.7, w: 9, h: 0.7, fill: { color: "EFF6FF" }, rectRadius: 0.1 });
  s4.addText("המערכת כבר פעילה ומוכחת בשטח — נבנתה מתוך ניסיון של מדריך שחייה", { x: 0.5, y: 4.7, w: 9, h: 0.7, fontSize: 14, fontFace: "Arial", bold: true, color: C.blue, align: "center", valign: "middle", margin: 0 });
  ...
  s7.addShape(pres.shapes.ROUNDED_RECTANGLE, { x: 6.0, y: 0.2, w: 3.7, h: 0.55, fill: { color: C.orange }, rectRadius: 0.1 });
  s7.addText("כלול בחבילת WhatsApp", { x: 6.0, y: 0.2, w: 3.7, h: 0.55, fontSize: 14, fontFace: "Arial", bold: true, color: C.white, align: "center", valign: "middle", margin: 0 });
  s7.addText("בונוס: דפי נחיתה מחוברים למערכת", { x: 0.5, y: 0.2, w: 5.5, h: 0.6, fontSize: 22, fontFace: "Arial", bold: true, color: C.navy, align: "right", margin: 0 });
  ...
  s10.addImage({ path: SL_LOGO, x: 7.5, y: 0.2, w: 2.2, h: 1.1 });
  s10.addImage({ path: NO_LOGO, x: 8.0, y: 4.2, w: 1.5, h: 1.2 });
  s10.addText("4 שכבות. פתרון אחד שלם.", { x: 0.5, y: 0.4, w: 7, h: 0.7, fontSize: 28, fontFace: "Arial", bold: true, color: C.white, align: "right", margin: 0 });
